...
L'évaluation réticente est une approche de gestion d'exécution qui vise à prévenir les surcharges de ressources au runtime. Dans le contexte d'un langage homoiconique avec des fonctions pures, cette approche présente des défis et des opportunités uniques.
